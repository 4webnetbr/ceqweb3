...
function gerarCampoNumeroPadrao(
  ...
  return `
        <div class="input-group input-group-sm d-inline-flex ${classeDiv}" style="max-width: 20ch;min-width: 15ch;font-size:10px">
...
function montarTabelaProdutos(classe, rt, dadosDep) {
  ...
  text.push(
    `<th class="vertical-th">${dadosDep.diaanterior === "S" ? "Consumo<br>" + dadosDep.dataOntem : "Média<br>" + dadosDep.meddias + " dias"}</th>`,
  );
