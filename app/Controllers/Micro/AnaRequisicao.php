...
class AnaRequisicao extends BaseController
{
    ...
    public function lista()
    {
        ...
        foreach ($dados_tela as &$req) {
            $url_ati            = base_url('/CriamPdf2026/PrintAnaRequisicao/' . $req['req_id']);
            $req['acao_person'] = [
                "<button type='button' class='btn btn-outline-black btn-sm border-0 mx-0 fs-0 float-end'
    ...
    public function store()
    {
        ...
        try {
            ...
            $link   = base_url('/CriamPdf2026/PrintAnaRequisicao/' . $req_id);
