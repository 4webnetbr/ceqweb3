...
class Operacao extends BaseController
{
    ...
    public function lista()
    {
        ...
        for ($p = 0; $p < sizeof($dados_opera); $p++) {
            ...
            if (strpbrk($this->permissao, 'X')) {
                ...
                $exclui =
                    "<button type='button' class='btn btn-outline-danger btn-sm' data-mdb-toggle='tooltip' data-mdb-placement='top' title='Excluir este Registro' onclick='excluir(\"" .
                    $url_del .
                    "\",\"" .
                    $opera['ope_nome'] .
    ...
    public function store()
    {
        ...
        if ($this->operacao->save($dados_lin)) {
            $ret['erro'] = false;
