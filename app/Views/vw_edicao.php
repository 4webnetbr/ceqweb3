                ...
                if ($display == 'tabela') {
                    ...
                    for ($c = 0; $c < sizeof($campos_se); $c++) {
                        ...
                        for ($cl = 0; $cl < (sizeof($campos_se_lin) - 2); $cl++) {
                            ...
                            if ($quebra == 'vazio2') {
                                echo "<div class='row col-6 col-lg-6 float-start d-inline-block g-1 align-items-center mb-0' style='height:33px'></div>";
                            } else if ($quebra == 'vazio3') {
                                echo "<div class='row col-4 col-lg-4 float-start d-inline-block g-1 align-items-center mb-3' style='height:33px'></div>";
                            } else {
                    ...
                    for ($c = 0; $c < sizeof($campos_se); $c++) {
                        ...
                        if ($quebra == 'vazio2') {
                            ...
                            echo "<div class='row col-6 col-lg-6 float-start d-block mb-0' style='height:33px; $clear'></div>";
                        } else if ($quebra == 'vazio3') {
                            $clear = 'clear: right;';
                            if ($count % 3) {
                                $clear = 'clear: left;';
                            }
                            echo "<div class='row col-4 col-lg-4 float-start d-block mb-3' style='height:33px; $clear'></div>";
                        } else {
                            echo $campos_se[$c];
                        }
                        $count++;
