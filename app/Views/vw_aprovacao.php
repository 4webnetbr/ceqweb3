...
<?php echo view('strut/vw_titulo_aprova'); ?>
    ...
    <form id="form1" data-alter method="post" action="<?php echo site_url($controler . "/" . $destino) ?>"
        ...
        if (sizeof($secoes)) {
            ...
            for ($s = 0; $s < count($secoes); $s++) {
                ...
                echo "<button type='button' class='nav-link $active' id='" . $secao . "-tab' data-bs-toggle='tab' data-bs-target='#" . $secao . "' type='button' role='tab' aria-controls='" . $secao . "' aria-selected='false'>";
                ...
                if ($display == 'tabela') {
                    ...
                    for ($c = 0; $c < sizeof($campos_se); $c++) {
                        ...
                        if ($quebra == 'vazio2') {
                            ...
                            echo "<div class='row col-6 col-lg-6 float-start d-block mb-0' style='height:70px; $clear'></div>";
                        } else if ($quebra == 'vazio3') {
                            $clear = 'clear: right;';
                            if ($count % 3) {
                                $clear = 'clear: left;';
                            }
                            echo "<div class='row col-4 col-lg-4 float-start d-block mb-0' style='height:70px; $clear'></div>";
                        } else {
                            echo $campos_se[$c];
                        }
                        $count++;
