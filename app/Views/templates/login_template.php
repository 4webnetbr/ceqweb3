...
<head>
  ...
  <title>Identificação - <?= NAME_APP ?></title>
  ...
  <!-- Estilo principal -->
  <link rel="stylesheet" href="<?php echo base_url('assets/css/bootstrap538.min.css'); ?>">
  ...
  <!-- <script src="<?php echo base_url('assets/fontawesome/js/all.min.js'); ?>" defer></script> -->
