...
<div id='content' class='container page-content bg-light m-0'>
  <div class="table-responsive col-12">
    <table id="table" class="display compact table table-sm table-info table-striped table-hover table-vertical-borders col-12">
      <thead class="table-default bg-table-blue-dark  col-12 overflow-x-auto">
        <tr class=' w-100' style='min-height:49px; height:49px;'>
          ...
          for ($c = 0; $c < sizeof($colunas); $c++) {
            echo "<th class='sticky-top text-center align-middle text-wrap '>
                  <h6 class='m-0'>$colunas[$c]</h6>
                  </th>";
          }
          ?>
        </tr>
...
<script type="text/javascript" language="javascript" src="<?php echo base_url('assets/jscript/my_consulta.js'); ?>"></script>
<script>
