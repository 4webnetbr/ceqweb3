...
?>
<div id='title' class='title col-12 px-lg-4 px-1 <?= $cor ?> float-start d-inline flex-nowrap' style="overflow-x: auto;overflow-y: hidden;font-size: clamp(0.8rem, 2rem - 1vw, 1.5rem) !important;">
