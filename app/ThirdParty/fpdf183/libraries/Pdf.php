...
class Pdf extends FPDF
{
    ...
    **/
    function header()
    {
		...
		$this->Cell(0,3,mb_convert_encoding('Artefatos de Metais Pelegrini Ltda', 'ISO-8859-1', 'UTF-8'),0,1,'R');
		$this->SetFont('Arial','',7);
		$this->Cell(0,3,mb_convert_encoding('CNPJ: 00.526.010/0001-65', 'ISO-8859-1', 'UTF-8'),0,1,'R');
		$this->Cell(0,3,mb_convert_encoding('I.E: 100.07351-04', 'ISO-8859-1', 'UTF-8'),0,1,'R');
		$this->Cell(0,3,mb_convert_encoding('R. Professor Alfredo Valente, 1158 - Jd Gramados - Alm. Tamandaré - CEP 83.504-000', 'ISO-8859-1', 'UTF-8'),0,1,'R');
		$this->Cell(0,3,mb_convert_encoding('Telefone: (41, 'ISO-8859-1', 'UTF-8') 3657-7755'),0,1,'R');
